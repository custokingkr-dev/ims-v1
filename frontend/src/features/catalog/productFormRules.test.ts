...
interface Fixture { name: string; rules: ProductRule[]; input: FormInput; expected: { pageCounts?: number[]; actualTotal?: number; requiredTotal?: number; valid?: boolean; error?: string } }
