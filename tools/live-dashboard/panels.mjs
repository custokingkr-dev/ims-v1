...
export const PANELS = [
  ...
  // SKU rates and needs no billing export at all.
  {
    id: "cost_grade",
    group: "money",
    title: "Billing data grade",
    note: "0 = estimated only · 1 = standard invoice-grade export · 2 = detailed resource-level export.",
    filter: `metric.type="${C("cost/billing_data_grade")}"`,
    aligner: "ALIGN_MEAN",
    reducer: "REDUCE_MAX",
    kind: "scorecard",
    format: "int",
  ...
  },
  {
    id: "cost_export_lag",
    group: "money",
    title: "Billing delivery lag (hours)",
    note: "Age of the newest invoice-grade export delivery. -1 means no matching usage export exists.",
    filter: `metric.type="${C("cost/export_lag_hours")}"`,
    aligner: "ALIGN_MEAN",
    reducer: "REDUCE_MAX",
    kind: "scorecard",
    format: "float1",
  ...
  },
  {
    id: "cost_usage_lag",
    group: "money",
    title: "Newest billed usage age (hours)",
    note: "How far the exported usage itself trails current operations; distinct from delivery lag.",
    filter: `metric.type="${C("cost/usage_lag_hours")}"`,
    aligner: "ALIGN_MEAN",
    reducer: "REDUCE_MAX",
    kind: "scorecard",
    format: "float1",
...
export const AUDIENCE = {
  ...
  ops: [
    ...
    "cost_grade", "cost_export_lag", "cost_usage_lag", "cost_mtd",
  ],
};
