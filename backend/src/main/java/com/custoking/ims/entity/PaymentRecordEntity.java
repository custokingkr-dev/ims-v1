...
public class PaymentRecordEntity {
    ...
    private long amount; private String mode; @Column(columnDefinition = "TEXT") private String notes; private OffsetDateTime paidAt; private Long recordedBy; private String receiptNumber; private OffsetDateTime createdAt = OffsetDateTime.now();
